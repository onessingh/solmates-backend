...
ALTER TABLE resumes ADD COLUMN resume_score INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE resumes DROP COLUMN resume_score;
...
DROP INDEX IF EXISTS idx_languages_resume_id;
...
DROP INDEX IF EXISTS idx_summary_resume_id;
